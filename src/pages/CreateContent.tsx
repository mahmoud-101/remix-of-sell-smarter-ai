...
export default function CreateContent() {
  ...
  // Handle product data extraction from URL
  const handleProductExtract = (data: ProductData) => {
    if (data.title) {
      const fullTitle = data.brand 
    ...
    if (data.description) {
      ...
      if (data.features && data.features.length > 0) {
        const topFeatures = data.features.slice(0, 5).join('\n• ');
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {/* Product URL Extractor - Server-side extraction using Firecrawl */}
                <ProductUrlExtractor onExtract={handleProductExtract} />
